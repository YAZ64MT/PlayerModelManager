...
CPPFLAGS := -DMIPS -DF3DEX_GBI_2 -DF3DEX_GBI_PL -DGBI_DOWHILE -DYAZMT_PMM_NO_API_IMPORTS -DLOGGER_PROJECT_NAME=\"PlayerModelManager\" -I include -I include/dummy_headers \
