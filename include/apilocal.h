...
bool PlayerModelManager_setDisplayListForModelTypeArray(PlayerModelManagerHandle h, PlayerModelManagerModelType types[], size_t n, Link_DisplayList dlId, Gfx *dl);
...
bool PlayerModelManager_setMatrixForModelTypeArray(PlayerModelManagerHandle h, PlayerModelManagerModelType types[], size_t n, Link_EquipmentMatrix mtxId, Mtx *matrix);
...
Gfx *PlayerModelManager_getBuiltInDisplayList(unsigned long apiVersion, PlayerModelManagerBuiltInDLId id);
Mtx *PlayerModelManager_getBuiltInMatrix(unsigned long apiVersion, PlayerModelManagerBuiltInMtxId id);
