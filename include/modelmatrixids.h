...
typedef enum Link_DisplayList {
    ...
    // Right hand holding longshot DLs
...
#define LINK_DL_OPT_LHAND_GUITAR LINK_DL_LHAND_GUITAR
...
typedef enum Link_EquipmentReplacement {
...
typedef enum Link_CustomModelCategory {
    LINK_CMC_CHILD,
    LINK_CMC_ADULT,
    LINK_CMC_HUMAN,
    LINK_CMC_DEKU,
    ...
    LINK_CMC_SLINGSHOT,
    LINK_CMC_BOTTLE,
    LINK_CMC_OCARINA_FAIRY,
    LINK_CMC_OCARINA_TIME,
    LINK_CMC_BOOMERANG,
    LINK_CMC_HAMMER,
    LINK_CMC_DEKU_STICK,
    LINK_CMC_PIPES,
    ...
    LINK_CMC_GUITAR,
    LINK_CMC_MASK_SKULL,
    LINK_CMC_MASK_SPOOKY,
    LINK_CMC_MASK_GERUDO,
    LINK_CMC_MASK_TRUTH,
    LINK_CMC_MASK_KAFEIS_MASK,
    LINK_CMC_MASK_ALL_NIGHT,
    LINK_CMC_MASK_BUNNY,
    LINK_CMC_MASK_KEATON,
    LINK_CMC_MASK_GARO,
    LINK_CMC_MASK_ROMANI,
    LINK_CMC_MASK_CIRCUS_LEADER,
    LINK_CMC_MASK_COUPLE,
    LINK_CMC_MASK_POSTMAN,
    LINK_CMC_MASK_GREAT_FAIRY,
    LINK_CMC_MASK_GIBDO,
    LINK_CMC_MASK_DON_GERO,
    LINK_CMC_MASK_KAMARO,
    LINK_CMC_MASK_CAPTAIN,
    LINK_CMC_MASK_STONE,
    LINK_CMC_MASK_BREMEN,
    LINK_CMC_MASK_BLAST,
    LINK_CMC_MASK_SCENTS,
    LINK_CMC_MASK_GIANT,
    LINK_CMC_MASK_DEKU,
    LINK_CMC_MASK_GORON,
    LINK_CMC_MASK_ZORA,
