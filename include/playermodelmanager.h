...
typedef enum {
    ...
    LINK_DL_ELEGY_OF_EMPTINESS_STATUE_HUMAN,
    LINK_DL_ELEGY_OF_EMPTINESS_STATUE_DEKU,
    LINK_DL_ELEGY_OF_EMPTINESS_STATUE_GORON,
    LINK_DL_ELEGY_OF_EMPTINESS_STATUE_ZORA,
    LINK_DL_BOOMERANG,
    LINK_DL_HAMMER,
