...
typedef enum {
    ...
    LINK_DL_MASK_DEITY_SCREAM,
    LINK_DL_MASK_DEKU_GI,
    LINK_DL_MASK_GORON_GI,
    LINK_DL_MASK_ZORA_GI,
    LINK_DL_MASK_DEITY_GI,
    LINK_DL_HAMMER,
...
typedef struct {
    ...
    FlexSkeletonHeader skeleton;
    Gfx *shimDisplayLists[LINK_SHIMDL_MAX];
    Mtx equipMtx[LINK_EQUIP_MATRIX_MAX];
