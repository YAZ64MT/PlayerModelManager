...
typedef enum PlayerModelManagerBuiltInDLId {
    ...
    PMM_BUILT_IN_DL_HUMAN_SWORD_KOKIRI_BLADE_AS_ADULT,
    PMM_BUILT_IN_DL_HUMAN_SWORD_KOKIRI_SHEATH,
    PMM_BUILT_IN_DL_HUMAN_SWORD_KOKIRI_SHEATH_AS_ADULT,
    PMM_BUILT_IN_DL_HUMAN_SWORD_RAZOR_HILT,
    PMM_BUILT_IN_DL_HUMAN_SWORD_RAZOR_HILT_AS_ADULT,
    PMM_BUILT_IN_DL_HUMAN_SWORD_RAZOR_BLADE,
    PMM_BUILT_IN_DL_HUMAN_SWORD_RAZOR_BLADE_AS_ADULT,
    PMM_BUILT_IN_DL_HUMAN_SWORD_RAZOR_SHEATH,
    PMM_BUILT_IN_DL_HUMAN_SWORD_RAZOR_SHEATH_AS_ADULT,
    PMM_BUILT_IN_DL_HUMAN_SWORD_GILDED_HILT,
    PMM_BUILT_IN_DL_HUMAN_SWORD_GILDED_HILT_AS_ADULT,
    PMM_BUILT_IN_DL_HUMAN_SWORD_GILDED_BLADE,
    PMM_BUILT_IN_DL_HUMAN_SWORD_GILDED_BLADE_AS_ADULT,
    PMM_BUILT_IN_DL_HUMAN_SWORD_GILDED_SHEATH,
    PMM_BUILT_IN_DL_HUMAN_SWORD_GILDED_SHEATH_AS_ADULT,
    PMM_BUILT_IN_DL_HUMAN_SWORD_GREAT_FAIRY,
    PMM_BUILT_IN_DL_HUMAN_SWORD_GREAT_FAIRY_AS_ADULT,
    PMM_BUILT_IN_DL_FIERCE_DEITY_SWORD,
    PMM_BUILT_IN_DL_FIERCE_DEITY_SWORD_AS_CHILD,
    PMM_BUILT_IN_DL_HUMAN_SHIELD_HERO,
    PMM_BUILT_IN_DL_HUMAN_SHIELD_HERO_AS_ADULT,
    PMM_BUILT_IN_DL_HUMAN_SHIELD_MIRROR,
    PMM_BUILT_IN_DL_HUMAN_SHIELD_MIRROR_AS_ADULT,
    PMM_BUILT_IN_DL_HUMAN_SHIELD_MIRROR_RAY,
    PMM_BUILT_IN_DL_HUMAN_SHIELD_MIRROR_RAY_AS_ADULT,
    PMM_BUILT_IN_DL_HUMAN_SHIELD_MIRROR_RAY_BEAM,
    PMM_BUILT_IN_DL_HUMAN_SHIELD_MIRROR_RAY_BEAM_AS_ADULT,
    PMM_BUILT_IN_DL_HUMAN_HOOKSHOT,
    PMM_BUILT_IN_DL_HUMAN_HOOKSHOT_AS_ADULT,
    PMM_BUILT_IN_DL_HUMAN_FPS_HOOKSHOT,
    PMM_BUILT_IN_DL_HUMAN_FPS_HOOKSHOT_AS_ADULT,
    PMM_BUILT_IN_DL_HUMAN_HOOKSHOT_HOOK,
    PMM_BUILT_IN_DL_HUMAN_HOOKSHOT_HOOK_AS_ADULT,
    PMM_BUILT_IN_DL_HUMAN_HOOKSHOT_CHAIN,
    PMM_BUILT_IN_DL_HUMAN_HOOKSHOT_CHAIN_AS_ADULT,
    PMM_BUILT_IN_DL_HUMAN_HOOKSHOT_RETICLE,
    PMM_BUILT_IN_DL_HUMAN_BOW,
    PMM_BUILT_IN_DL_HUMAN_BOW_AS_ADULT,
    PMM_BUILT_IN_DL_HUMAN_FPS_BOW,
    PMM_BUILT_IN_DL_HUMAN_FPS_BOW_AS_ADULT,
    PMM_BUILT_IN_DL_HUMAN_BOW_STRING,
    PMM_BUILT_IN_DL_HUMAN_BOW_STRING_AS_ADULT,
    PMM_BUILT_IN_DL_HUMAN_ARROW,
    PMM_BUILT_IN_DL_MM_BOTTLE_GLASS,
    PMM_BUILT_IN_DL_MM_BOTTLE_FILLING,
    PMM_BUILT_IN_DL_HUMAN_OCARINA_TIME,
    PMM_BUILT_IN_DL_HUMAN_OCARINA_TIME_AS_ADULT,
    PMM_BUILT_IN_DL_HUMAN_DEKU_STICK,
    PMM_BUILT_IN_DL_DEKU_PIPE_MOUTH,
    PMM_BUILT_IN_DL_DEKU_PIPE_RIGHT,
    PMM_BUILT_IN_DL_DEKU_PIPE_UP,
    PMM_BUILT_IN_DL_DEKU_PIPE_DOWN,
    PMM_BUILT_IN_DL_DEKU_PIPE_LEFT,
    PMM_BUILT_IN_DL_DEKU_PIPE_A,
    PMM_BUILT_IN_DL_GORON_DRUM_STRAP,
    PMM_BUILT_IN_DL_GORON_DRUM_UP,
    PMM_BUILT_IN_DL_GORON_DRUM_LEFT,
    PMM_BUILT_IN_DL_GORON_DRUM_RIGHT,
    PMM_BUILT_IN_DL_GORON_DRUM_DOWN,
    PMM_BUILT_IN_DL_GORON_DRUM_A,
    PMM_BUILT_IN_DL_ZORA_GUITAR,
    PMM_BUILT_IN_DL_HUMAN_MASK_TRUTH,
    PMM_BUILT_IN_DL_HUMAN_MASK_KAFEIS_MASK,
    PMM_BUILT_IN_DL_HUMAN_MASK_ALL_NIGHT,
    PMM_BUILT_IN_DL_HUMAN_MASK_BUNNY,
    PMM_BUILT_IN_DL_HUMAN_MASK_KEATON,
    PMM_BUILT_IN_DL_HUMAN_MASK_GARO,
    PMM_BUILT_IN_DL_HUMAN_MASK_ROMANI,
    PMM_BUILT_IN_DL_HUMAN_MASK_CIRCUS_LEADER,
    PMM_BUILT_IN_DL_HUMAN_MASK_COUPLE,
    PMM_BUILT_IN_DL_HUMAN_MASK_POSTMAN,
    PMM_BUILT_IN_DL_HUMAN_MASK_GREAT_FAIRY,
    PMM_BUILT_IN_DL_HUMAN_MASK_GIBDO,
    PMM_BUILT_IN_DL_HUMAN_MASK_DON_GERO,
    PMM_BUILT_IN_DL_HUMAN_MASK_KAMARO,
    PMM_BUILT_IN_DL_HUMAN_MASK_CAPTAIN,
    PMM_BUILT_IN_DL_HUMAN_MASK_STONE,
    PMM_BUILT_IN_DL_HUMAN_MASK_BREMEN,
    PMM_BUILT_IN_DL_HUMAN_MASK_BLAST,
    PMM_BUILT_IN_DL_HUMAN_MASK_BLAST_COOLING_DOWN,
    PMM_BUILT_IN_DL_HUMAN_MASK_SCENTS,
    PMM_BUILT_IN_DL_HUMAN_MASK_GIANT,
    PMM_BUILT_IN_DL_HUMAN_MASK_DEKU,
    PMM_BUILT_IN_DL_HUMAN_MASK_GORON,
    PMM_BUILT_IN_DL_HUMAN_MASK_ZORA,
    PMM_BUILT_IN_DL_HUMAN_MASK_FIERCE_DEITY,
    PMM_BUILT_IN_DL_HUMAN_MASK_DEKU_SCREAM,
    PMM_BUILT_IN_DL_HUMAN_MASK_GORON_SCREAM,
    PMM_BUILT_IN_DL_HUMAN_MASK_ZORA_SCREAM,
    PMM_BUILT_IN_DL_HUMAN_MASK_FIERCE_DEITY_SCREAM,
    PMM_BUILT_IN_DL_HUMAN_RHAND_OCARINA,
    PMM_BUILT_IN_DL_HUMAN_FPS_RHAND,
    PMM_BUILT_IN_DL_MAX,
