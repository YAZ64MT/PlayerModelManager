...
typedef enum {
    ...
    PMM_DL_ELEGY_OF_EMPTINESS_STATUE_HUMAN,
    PMM_DL_ELEGY_OF_EMPTINESS_STATUE_DEKU,
    PMM_DL_ELEGY_OF_EMPTINESS_STATUE_GORON,
    PMM_DL_ELEGY_OF_EMPTINESS_STATUE_ZORA,
    PMM_DL_BOOMERANG,
    PMM_DL_HAMMER,
...
#define PMM_DLSWORD_KOKIRI_HILT PMM_DLSWORD1_HILT
#define PMM_DLSWORD_KOKIRI_BLADE PMM_DLSWORD1_BLADE
#define PMM_DLSWORD_KOKIRI_SHEATH PMM_DLSWORD1_SHEATH

#define PMM_DLSWORD_RAZOR_HILT PMM_DLSWORD2_HILT
#define PMM_DLSWORD_RAZOR_BLADE PMM_DLSWORD2_BLADE
#define PMM_DLSWORD_RAZOR_SHEATH PMM_DLSWORD2_SHEATH

#define PMM_DLSWORD_GILDED_HILT PMM_DLSWORD3_HILT
#define PMM_DLSWORD_GILDED_BLADE PMM_DLSWORD3_BLADE
#define PMM_DLSWORD_GILDED_SHEATH PMM_DLSWORD3_SHEATH

#define PMM_DLSWORD_GREAT_FAIRY_HILT PMM_DLSWORD4_HILT
#define PMM_DLSWORD_GREAT_FAIRY_BLADE PMM_DLSWORD4_BLADE

#define PMM_DLSWORD_FIERCE_DEITY_HILT PMM_DLSWORD4_HILT
#define PMM_DLSWORD_FIERCE_DEITY_BLADE PMM_DLSWORD4_BLADE

#define PMM_DLSHIELD_HERO PMM_DLSHIELD2

#define PMM_DLSHIELD_MIRROR PMM_DLSHIELD3
#define PMM_DLSHIELD_MIRROR_RAY PMM_DLSHIELD3_RAY
