...
static const EquipmentOverride sEquipmentOverrideTable[LINK_DL_REPLACE_MAX] = {
    ...
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sBowDLs),              // LINK_DL_REPLACE_BOW
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sSlingshotDLs),        // LINK_DL_REPLACE_SLINGSHOT
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sBottleDLs),           // LINK_DL_REPLACE_BOTTLE
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sOcarinaFairyDLs),     // LINK_DL_REPLACE_OCARINA_FAIRY
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sOcarinaTimeDLs),      // LINK_DL_REPLACE_OCARINA_TIME
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sBoomerangDLs),        // LINK_DL_REPLACE_BOOMERANG
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sHammerDLs),           // LINK_DL_REPLACE_HAMMER
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sDekuStickDLs),        // LINK_DL_REPLACE_DEKU_STICK
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sPipesDLs),            // LINK_DL_REPLACE_PIPES
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sDrumsDLs),            // LINK_DL_REPLACE_DRUMS
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sGuitarDLs),           // LINK_DL_REPLACE_GUITAR
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sMaskSkullDLs),        // LINK_DL_REPLACE_MASK_SKULL
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sMaskSpookyDLs),       // LINK_DL_REPLACE_MASK_SPOOKY
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sMaskGerudoDLs),       // LINK_DL_REPLACE_MASK_GERUDO
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sMaskTruthDLs),        // LINK_DL_REPLACE_MASK_TRUTH
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sMaskKafeisMaskDLs),   // LINK_DL_REPLACE_MASK_KAFEIS_MASK
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sMaskAllNightDLs),     // LINK_DL_REPLACE_MASK_ALL_NIGHT
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sMaskBunnyDLs),        // LINK_DL_REPLACE_MASK_BUNNY
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sMaskKeatonDLs),       // LINK_DL_REPLACE_MASK_KEATON
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sMaskGaroDLs),         // LINK_DL_REPLACE_MASK_GARO
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sMaskRomaniDLs),       // LINK_DL_REPLACE_MASK_ROMANI
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sMaskCircusLeaderDLs), // LINK_DL_REPLACE_MASK_CIRCUS_LEADER
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sMaskCoupleDLs),       // LINK_DL_REPLACE_MASK_COUPLE
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sMaskPostmanDLs),      // LINK_DL_REPLACE_MASK_POSTMAN
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sMaskGreatFairyDLs),   // LINK_DL_REPLACE_MASK_GREAT_FAIRY
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sMaskGibdoDLs),        // LINK_DL_REPLACE_MASK_GIBDO
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sMaskDonGeroDLs),      // LINK_DL_REPLACE_MASK_DON_GERO
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sMaskKamaroDLs),       // LINK_DL_REPLACE_MASK_KAMARO
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sMaskCaptainDLs),      // LINK_DL_REPLACE_MASK_CAPTAIN
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sMaskStoneDLs),        // LINK_DL_REPLACE_MASK_STONE
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sMaskBremenDLs),       // LINK_DL_REPLACE_MASK_BREMEN
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sMaskBlastDLs),        // LINK_DL_REPLACE_MASK_BLAST
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sMaskScentsDLs),       // LINK_DL_REPLACE_MASK_SCENTS
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sMaskGiantDLs),        // LINK_DL_REPLACE_MASK_GIANT
    DECLARE_OVERRIDE_TABLE_ENTRY_NO_MTX(sMaskDekuDLs),         // LINK_DL_REPLACE_MASK_DEKU
