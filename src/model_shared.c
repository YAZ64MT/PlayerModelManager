...
#define SET_MASK_DL(linkDL, objectId, maskDL) (setupSharedListenerDL(objectId, maskDL, linkDL))
    ...
    SET_MASK_DL(LINK_DL_MASK_FIERCE_DEITY_SCREAM, GAMEPLAY_KEEP, object_mask_boy_DL_000900);
    SET_MASK_DL(LINK_DL_MASK_GORON_SCREAM, GAMEPLAY_KEEP, object_mask_goron_DL_0014A0);
    SET_MASK_DL(LINK_DL_MASK_ZORA_SCREAM, GAMEPLAY_KEEP, object_mask_zora_DL_000DB0);
